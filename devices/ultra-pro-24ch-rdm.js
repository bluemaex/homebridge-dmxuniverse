...
function UltraPro(accessory, log, config) {
  this.log = log
...
UltraPro.prototype.setupCharacteristics = function() {
...
UltraPro.prototype.configure = function() {
  const service = this.accessory.getService(Service.Lightbulb)
...
UltraPro.prototype.identify = function(paired, callback) {
  this.log("%s please identify yourself!", this.accessory.displayName)
  callback(null)
}

UltraPro.prototype.getState = function(who, callback) {
  this.getDmxState()
    .then(() => {
...
UltraPro.prototype.setState = function(who, value, callback) {
...
UltraPro.prototype.getDmxState = function() {
...
UltraPro.prototype.setDmxState = function() {
  var data = {
